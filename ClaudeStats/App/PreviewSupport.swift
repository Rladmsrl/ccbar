...
extension AppEnvironment {
    ...
    static func preview(populated: Bool = true) -> AppEnvironment {
        ...
        let suiteName = "com.rladmsrl.preview"
...
extension Session {
    static func previewSamples(pricing: ModelPricing = .fallback) -> [Session] {
        ...
        return [
            ...
            Session(
                id: "claude::d4", externalID: "d4", provider: .claude,
                projectDirectoryName: "/Users/dev/projects/tag",
                filePath: "/Users/dev/.claude/projects/2026/01/01/d4.jsonl",
                ...
                stats: SessionStats(
                    ...
                    models: [model("claude-haiku-4-5", 14, usage(40_000, 6_000, 120_000))],
                    timeline: [
                        bucket(1, 11, "claude-haiku-4-5", usage(22_000, 3_000, 70_000)),
                        bucket(1, 12, "claude-haiku-4-5", usage(18_000, 3_000, 50_000)),
                    ]
                )
            ),
        ]
